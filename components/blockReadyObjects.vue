  ...
  <div class="wrap-cont6">
    <div class="container container-ready-objects">
      <div class="block-ready-object">
        ...
        <div class="dt dt2">
          <template v-if="!formSubmitedModal">
            <div class="h4-text">
          ...
          <template v-else>
            <div class="accept-mess accept-mess2">
              ...
              <div class="text-src">
                <img width="43" height="43" draggable="false" src="../assets/images/ico-phone-2.svg" alt=""/>
...
export default {
  ...
  mounted() {
    // this.sendPhone();
    const config = useRuntimeConfig();
    console.log( this.$config.VITE_APP_SERVICE_ID)
  },
  methods: {
    uploadFile(){
